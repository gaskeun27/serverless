...
const getSharedDirectStackActionParams = require('../lib/get-shared-direct-stack-action-params');
...
class AwsDeploy {
  constructor(serverless, options) {
    ...
    Object.assign(
      ...
      getSharedDirectStackActionParams
    );
    ...
    this.hooks = {
      ...
      'error': async () => {
        ...
        if (this.console.isEnabled && this.console.isFreshOtelIngestionToken) {
          await this.console.deactivateOtelIngestionToken();
        }
